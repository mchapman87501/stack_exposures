...
namespace {
struct StretchImageStacker : public IImageStacker {
  StretchImageStacker() : m_image(), m_dark_image() {}
...
struct MeanImageStacker : public IImageStacker {
  MeanImageStacker() : m_image(), m_dark_image() {}
...
IImageStacker::Ptr mean() { return std::make_unique<MeanImageStacker>(); }
IImageStacker::Ptr stretch() { return std::make_unique<StretchImageStacker>(); }
} // namespace ImageStacker
